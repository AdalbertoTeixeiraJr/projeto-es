...
static const char *const yytname[] =
{
  ...
  "MINUS", "PLUS", "MULT", "DIV", "APAREN", "FPAREN", "BEGIN", "END",
  "ATRIB", "TYPE_INT", "MAIN", "ANDBIT", "ORBIT", "RELOP", "LOGOP", "INT",
  "ID", "$accept", "programa", 0
};
#endif
