...
<input class="minimo" type="radio" title="Escolha uma opção" name="sexo" id="sexoM"value="true"><label for="sexoM" class="pequeno">&nbsp;Masculino</label><br/>
<input class="minimo" type="radio" title="Escolha uma opção" name="sexo" id="sexoF"value="false"><label for="sexoF" class="pequeno">&nbsp;Feminino</label><br/>
</fieldset>
...
<label for="filiacao" class="monitor">Prof. Orientador </label><input type="text" name="profOrientador" class="monitor"/>
...
<label for="notaDisciplina" class="monitor">Nota Disciplina </label><input type="text"name="notaDisciplina" class="monitor" disabled ="disabled"/>
<label for="notasObtidas" class="monitor">Nota Obtida </label><input type="text" name="notasObtidas" class="monitor"  disabled ="disabled"/><br/>
<label for="cra" class="minimo" >CRA</label><input class="pequeno" type="text" name="cra" disabled="disabled" class="monitor"  disabled ="disabled"/>
...
<label for="avaComplementares" class="monitor">Aval Complem </label><input type="text" name="avaComplementares"class="grande" disabled ="disabled"/><br/>
</fieldset>
<br/>
